...
const FILAMENTS: Filament[] = [
  ...
  { name: 'Conductive', subtitle: 'Conductive PLA or ABS', printTempLow: 215, printTempHigh: 230, bedTempLow: null, bedTempHigh: null, strength: 2, flexibility: 2, durability: 2, difficulty: 2, shrinkage: 2, soluble: 'No', foodSafe: false, blueTape: true, glueStick: true, typicalUses: 'Electronics', color: '#2c3e50' },
  ...
  { name: 'Metal PLA / ABS', subtitle: 'Metal Powder and PLA or ABS blend', printTempLow: 195, printTempHigh: 220, bedTempLow: null, bedTempHigh: null, strength: 3, flexibility: 1, durability: 3, difficulty: 3, shrinkage: 2, soluble: 'No', foodSafe: false, blueTape: false, glueStick: false, typicalUses: 'Jewellery', color: '#7f8c8d' },
  ...
  { name: 'Nylon', subtitle: 'Polyamide', printTempLow: 220, printTempHigh: 260, bedTempLow: 50, bedTempHigh: 100, strength: 4, flexibility: 3, durability: 4, difficulty: 4, shrinkage: 4, soluble: 'No', foodSafe: true, blueTape: true, glueStick: false, typicalUses: 'All Purpose', color: '#2c3e80' },
  ...
  { name: 'Wax (MOLDLAY)', subtitle: 'Wax-like properties', printTempLow: 170, printTempHigh: 180, bedTempLow: null, bedTempHigh: null, strength: 1, flexibility: 2, durability: 1, difficulty: 3, shrinkage: 2, soluble: 'No', foodSafe: false, blueTape: false, glueStick: false, typicalUses: 'Lost Wax Casting', color: '#636e72' },
